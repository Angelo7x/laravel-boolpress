    ...
    <div class="container">
      ...
      <div class="nav-scroller py-1 mb-2">
        {{-- <nav class="nav d-flex">
          <a class="p-2 text-muted" href="{{route("homepage")}}">Home</a>
          <a class="p-2 text-muted" href="{{route("posts.index")}}">Blog</a>
          <a class="p-2 text-muted" href="{{route("about")}}">Chi Sono</a>
          <a class="p-2 text-muted" href="{{route("contact")}}">Contatti</a>
        </nav> --}}
      </div>
